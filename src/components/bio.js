    ...
    render() {
        ...
        return (
            <div style={headerStyle} className="bio">
                ...
                <h3 style={{ textAlign: 'center', color: 'red' }}><a href="https://drive.google.com/file/d/1hyhuBi_FrKOqP2FSennh_dgWC8uVMHJN/view" style={{ textDecoration: 'underline wavy red', color: 'red' }}>resume</a></h3>
